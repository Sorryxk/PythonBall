...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        super().__init__()
        self.sprites_up = [
            pygame.transform.scale(pygame.image.load('personagens/realmadrid_cima.jpg'), (50, 50)),
            pygame.transform.scale(pygame.image.load('personagens/realmadrid_correndo_cima.jpg'), (50, 50))
        ]
        self.sprites_down = [
            pygame.transform.scale(pygame.image.load('personagens/realmadrid_baixo.jpg'), (50, 50)),
            pygame.transform.scale(pygame.image.load('personagens/realmadrid_correndo_baixo.jpg'), (50, 50))
        ]
